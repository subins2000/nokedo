...
jQuery.fn.tload = function(){$(this).html("<img src='//cdn.nokedo.com/images/load.gif' style='margin:0px auto;display:block;'/><br/><center style='color:black;'>Loading.....</center>");};
...
jQuery.jsave = function(div,text,ti,t){if(text==null){text=div;}else{text=text;}if(ti==null){ti='Saving';t='Saved';}
jQuery(text).text(ti+'....');jQuery(div).show();
jQuery(text).text(t+'....');$(div).delay('3000').hide('100');
};
