...
<div id="content" style="display: table;">
 ...
 <div class="messages">
  ...
  <?if($v){?>
  <form class="msgform">
   <input type="text" style="width:80%;" name="msg" autocomplete="off" placeholder="Type Message Here and Hit Enter"/>
   <input type="hidden" name="room" value="<?echo$id;?>"/>
   <input type="hidden" id="isroom" value="true"/>
