...
function send_mail($mail,$subject,$msg) {
 $msg='<div style="width:100%;background:#CCC;border:2px solid black;height:100px;"><h1><a href="//nokedo.com"><img style="margin-left:40px;float:left;" src="//cdn.nokedo.com/images/logo.png"></a></h1><div style="float:right;margin-right:40px;font-size:20px;margin-top:20px"><a href="//nokedo.com/accounts">Manage Account</a>&nbsp;&nbsp;&nbsp;<a href="//nokedo.com/accounts/ResetPassword.php">Forgot password ?</a></div></div><div style="margin-left: 10px;border: 3px solid black;padding: 0px 10px;border-radius:10px;margin-right:10px">'.$msg.'</div><br>Report bugs, errors and problems directly to <a href="mailto:subins2000@gmail.com">subins2000@gmail.com</a></div><br>';
 $ch = curl_init();
