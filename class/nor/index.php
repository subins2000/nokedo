...
<div id="content">
 <div class='lside'>
  ...
  ?>
   ...
   <a href="//class.nokedo.com/nor">Switch to Nor Network</a><br/><a href="//class.nokedo.com/pro">Switch to Dev Network</a>
  </div>
 </div>
 <div class='rside'>
  <form class="postform">
   ...
   <div id="feed">
    <?$_GET['awregvawegb']=1;$_POST['nor']='1';include('../data.php');?>
   </div>
