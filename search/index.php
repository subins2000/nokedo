...
<div style="margin:10% auto;text-align:center;">
 <div id="search">
  <center><br/><a href="//nokedo.com" style="display:table;"><div style="background: url(//cdn.nokedo.com/images/logo.png);height: 1px;width: 120px;padding-top: 47px;background-repeat: no-repeat;padding-left: 96px;">For Developers</div></a><br/></center>
  <form id="vlform" action="search.php">
  <input type="hidden" value="1" name="p">
  <input id="vls" placeholder="Search for something about programming." type="text" size="40" name="q">
