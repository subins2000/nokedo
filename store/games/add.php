...
Type:<select onload="$(this).find('[value=<?echo$_POST['pl'];?>]').attr('selected')" name="pl"><option value="Flash">Flash</option><option value="Downloadable">Downloadable</option></select><br/>
<input type="submit"/>
</form>
<?
